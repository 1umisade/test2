...
Click “↩ Return to OEC” to jump back to the related step in the main page.

---

### H₂O molecules are pulled toward the OEC through the *Pulling_area* and begin to approach the *Center*. <a id="oec-step-1"></a>
...
### Two waters reach the OEC *Center*, pause physics, disable colliders, and lock to anchor positions. <a id="oec-step-2"></a>
...
### *deelectronation_of_H2O()* proceeds H₂O → OH → O, spawning electrons to the chain and protons to the lumen. <a id="oec-step-3"></a>
