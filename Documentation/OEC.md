      ...
      <tr>
        <td align="center">
          <img src="../Project/Graphics/Oxygen-evolving_complex/oxygen_evolving_complex_SimpleSprite.png"
                alt="Oxygen-evolving complex (OEC)" height="220" />
      ...
      <tr>
        <td>
          <ul>
            ...
            <li><b>Outputs:</b> 1 × O₂ entity, 4 × H⁺ (proton) entities, 4 e⁻ to PSII chain.</li>
            <li><b>Progression:</b> Each PSII photon advances the OEC S-state by +1.</li>
            <li><b>Trigger:</b> Upon reaching S<sub>4</sub>, consume 2 H₂O, spawn 1 O₂, emit 4 H⁺ to lumen,
                deliver 4 e⁻ toward P680/Pheophytin, then reset to S<sub>0</sub>.</li>
            <li><b>Counts/UI:</b> Increment O₂ and H⁺ counters on spawn; decrement H₂O by 2.</li>
            <li><b>Failure case:</b> If fewer than 2 H₂O are present when S<sub>4</sub> is reached,
                pause at S<sub>3</sub>/S<sub>4</sub> until H₂O becomes available.</li>
            <li><b>Placement:</b> Lumen-facing; proton spawn direction toward lumen/up.</li>
          </ul>
